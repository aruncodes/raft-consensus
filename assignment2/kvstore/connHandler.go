...
func clientConnManager() {

	clientMap = make(map[raft.Lsn]net.Conn) //Create client map
	kvResponse = make(chan KVResponse)      //Init response channel
...
func handleOneCommand(clientConn net.Conn, response KVResponse) {
